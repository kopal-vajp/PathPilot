...
import { regenerateIndustryInsights, deleteIndustryInsights } from "@/actions/dashboard";
import {
  BarChart,
  Bar,
  XAxis,
...
const DashboardView = ({ insights }) => {
  ...
  const handleReset = async () => {
    if (window.confirm("Are you sure you want to reset your insights?")) {
      try {
        setIsDeleting(true);
        await deleteIndustryInsights();
        router.refresh();
      } catch (error) {
